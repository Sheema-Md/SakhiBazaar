    ...
    <select name = "order-type">
      ...
      <option value="request">Order Request</option>
         ...
         <div class="actions form-section">
           <button type="submit" name="action" value="draft" style = "background-color: #7e22ce;
           color: white;">Save as Draft</button>
  <button type="submit" name="action" value="publish" style = "background-color: #ffc107;
           color: black;">Publish Product</button>
